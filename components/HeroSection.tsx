    ...
    <>
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-lg lg:py-16 lg:px-12">
          ...
          {!ready && (
            <div className="flex justify-center items-center my-8 divide-x divide-gray-200 dark:divide-gray-700 sm:hidden">
              ...
              <a
                href="#"
                className="pl-3 text-gray-900 sm:pl-5 dark:text-white"
              >
                <svg
                  className="h-6"
                  viewBox="0 0 107 21"
