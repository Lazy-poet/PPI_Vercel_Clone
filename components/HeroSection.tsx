    ...
    <>
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-12">
          ...
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl text-center sm:px-16 xl:px-48 dark:text-gray-400">
            Discover if you&apos;re eligible for a tax refund in just 60 seconds
            – simply enter your name below to get started!
          </p>
          <form
            action="#"
            className="w-full grid grid-cols-1 gap-5 md:gap-8 p-6 mx-auto mb-16 max-w-screen-md bg-white rounded-lg border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 sm:grid-cols-2"
          >
            <div
