    ...
    >
      <div
        ...
        className={
          !showBanner
            ? "hidden"
            : "flex z-50 fixed justify-between py-3 px-4 w-full bg-[#FACA15] border-b border-gray-200 dark:border-gray-700"
        }
      >
        <div className="flex items-center mx-auto gap-2">
          ...
          <p className="text-sm font-medium text-black md:my-0 ">
