...
const Title = ({ step, onClick }: Props) => {
  const { userData, titleRef } = useSystemValues();
  return (
    <div className="w-full pt-4 mx-auto text-center lg:pt-8">
      <h1
        ref={titleRef}
        className="max-w-screen-xl mx-auto text-left mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white"
      >
        {TITLES[step](userData.firstName)}
      </h1>
